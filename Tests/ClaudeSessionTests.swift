...
/// The session Khih starts itself must never reach the notch.
///
...
/// carries the pid of the process Khih spawned. Left alone it draws a row
...
final class ClaudeOwnSessionFilterTests: XCTestCase {
    ...
    func testAnIgnoredPidIsLeftOut() throws {
        ...
        XCTAssertTrue(found.isEmpty, "the session Khih started is not the user's")
    }
